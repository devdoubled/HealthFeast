  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        ...
        // })}
        options={({ navigation, route }) => {
          const { mealScreen } = route.params || {}; // Assuming `mealType` is passed as a parameter
      
          // Determine the title based on the mealType parameter
          let title = "Bữa sáng"; // Default title
          if (mealType === "lunch") {
            title = "Bữa trưa";
