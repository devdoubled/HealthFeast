...
export const getIcon = (exercise)  => {
    if(exercise === "Chạy bộ") {
        return (<FontAwesome5 name="running" size={26} color="#E55733" />)
    }else if (exercise === "Bơi lội") {
        return (<FontAwesome5 name="swimmer" size={26} color="#E55733" />)
    }else if (exercise === "Đá bóng") {
        return (<FontAwesome name="soccer-ball-o" size={26} color="#E55733" />)
    }else if (exercise === "Bóng rổ") {
        return (<FontAwesome5 name="basketball-ball" size={26} color="#E55733" />)
