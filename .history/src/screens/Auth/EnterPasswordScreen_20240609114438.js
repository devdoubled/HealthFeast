...
const EnterPasswordScreen = ({ navigation, route }) => {
  ...
  const handlePressNewPassword = () => {
    if (!isValidPassword(password)) {
      setErrorMsg("Password must be at least 6 characters long and include a mix of uppercase letters, lowercase letters, and numbers.");
      setIsLoading(false);
      return;
    }
