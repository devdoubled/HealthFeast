  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.input_container, { width }]}>
        ...
        <Pressable
          style={({ pressed }) => [
            styles.login_google_btn,
            pressed && styles.login_btn_pressed,
          ]}
        >
          <View style={styles.login_social_content}>
            <Image source={Apple} style={styles.login_social_img} />
            <Text style={styles.login_social_text}>Đăng nhập với Google</Text>
