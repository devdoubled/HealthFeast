      ...
      >
        <View style={styles.result_item}>
          ...
          <View style={styles.result_value}>
            <Text style={styles.value}>170 <Text style={styles.unit}>cm</Text></Text>
        ...
        <View style={styles.result_item}>
          ...
          <View style={styles.result_value}>
            <Text style={styles.value}>22.4 BMR</Text>
        ...
        <View style={styles.result_item}>
          ...
          <View style={styles.result_value}>
            <Text style={styles.value}>1.2 BMI</Text>
        ...
        <View style={styles.result_item}>
          ...
          <View style={styles.result_value}>
            <Text style={styles.value}>2500 kCal</Text>
            <Text style={styles.description}></Text>
          </View>
        </View>
        <View style={styles.result_item}>
