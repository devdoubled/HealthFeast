  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.weight_container, { width: width - 60 }]}>
        ...
        <Image source={askingIcon2} style={styles.icon_1}/>
        <Image source={askingIcon3} style={styles.icon_1}/>
        <Image source={askingIcon4} style={styles.icon_1}/>
        <Image source={askingIcon5} style={styles.icon_1}/>
      </View>
