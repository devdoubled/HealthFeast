...
const PurposeScreen = () => {
  ...
  const [activeId, setActiveId] = useState(null); // State to keep track of active item id

  const handlePress = (id) => {
    setActiveId(id === activeId ? null : id); // Toggle active state based on id
  };
  return (
          ...
          <TouchableOpacity
            ...
            style={[
              styles.purpose_item,
              {
                ...
                backgroundColor: item.id === activeId ? 'lightblue' : 'transparent',
              },
            ]}
          >
