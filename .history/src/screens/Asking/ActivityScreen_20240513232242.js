...
const ActivityScreen = () => {
  ...
  const getActivityDetails = (value) => {
    ...
    if (value >= 1 && value < 25) {
      ...
      description = "Lối sống gắn liền với bàn làm việc và tập thể dục hàng ngày hoặc đi bộ";
    } else if (value >= 50 && value < 75) {
      activityType = "Vừa phải";
      image = ActivityNormal;
      description = "Công việc đòi hỏi bạn phải đứng vững (ví dụ: bồi bàn, đưa thư) hoặc 1 giờ tập thể dục 3-5 lần một tuần";
    } else {
