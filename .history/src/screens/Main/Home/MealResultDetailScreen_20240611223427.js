...
const MealResultDetailScreen = ({ route }) => {
  ...
  const handlePressMinusValueCalories = () => {
    ...
    setValueChooseCalories((prev) => {
      ...
      setValueCarb(newValue * (valueCalories / valueChooseCalories));
      setValueProtein(newValue * (valueCalories / valueChooseCalories));
      setValueFat(newValue * (valueCalories / valueChooseCalories));
      return newValue;
    });
  };
