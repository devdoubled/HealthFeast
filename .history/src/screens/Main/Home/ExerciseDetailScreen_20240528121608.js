...
import { runningData,
  ...
  cyclingData,
  cardioData,
  gymData } from "../../../data/exerciseData"
      ...
      <View style={[styles.exercise_detail_container, { width: width - 32 }]}>
        ...
        <View style={styles.info_container}>
          ...
          <View style={styles.exercise_options}>
            ...
            <ExerciseDropdown data={() => {
              if(typeEx === "Chạy bộ") return runningData
              else if(typeEx === "Bơi lội") return swimmingData
              else if(typeEx === "Đá bóng") return soccerData
              else if(typeEx === "Bóng rổ") return basketballData
              else if(typeEx === "Đạp xe") return cyclingData
              else if(typeEx === "Carido") return runningData
              else return gymData
            }}/>
          </View>
