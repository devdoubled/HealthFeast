  ...
  return (
    ...
    >
      ...
      <View style={[styles.macro_tracking, { width: width - 32 }]}>
        ...
        <MacroBar label="Đạm" value={Math.round(mealStatisticHistory.total)} maxValue={Math.round(userStatistic.proteinRecommended)} color="#B266FD" />
        <MacroBar label="Chất béo" value={Math.round(mealStatisticHistory)} maxValue={Math.round(userStatistic.fatRecommended)} color="#5285E8" />
      </View>
      {/* Exercise tracking */}
