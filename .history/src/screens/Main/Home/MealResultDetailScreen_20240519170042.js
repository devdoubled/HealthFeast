...
const MealResultDetailScreen = () => {
  ...
  const [valueCalories, setValueCalories] = useState(25)
  ...
  const handlePressMinusValueCalories = () => {
    ...
    setValueChooseCalories((prev) => {
      ...
      setValueCalories(newValue * 0.25); // Update valueCalories based on new valueChooseCalories
      return newValue;
    });
  };

  const handlePressPlusValueCalories = () => {
    setValueChooseCalories((prev) => prev + 5);
  };
  return (
