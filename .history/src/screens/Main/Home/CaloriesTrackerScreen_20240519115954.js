  ...
  return (
    ...
    >
      ...
      <View style={[styles.premium_container, { width: width - 32 }]}>
        ...
        <Text style={styles.premium_description}>Mở khóa cao cấp để tìm hiểu loại thực phẩm nào bạn đã đăng nhập có lượng calo cao nhất</Text>
        <Pressable styls={styles.go_premium}>
          <Text styls={styles.go_premium_text}>Đi đén Premium</Text>
        </Pressable>
      </View>
    </ScrollView>
  );
