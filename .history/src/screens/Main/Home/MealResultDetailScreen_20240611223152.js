...
const MealResultDetailScreen = ({ route }) => {
  ...
  const [valueCarb, setValueCarb] = useState(meal.totalCalories)
  const [valueFat, setValueFat] = useState(meal.totalCalories)
  const [valueProtein, setValueProtein] = useState(meal.totalCalories)
