      ...
      <View style={[styles.tracker_container, { width: width - 32 }]}>
        ...
        <View style={styles.explain_container}>
          <Text style={styles.calculate}>
            {roundToDecimal(userStatistic.tdee) - (mealStatisticHistory?.totalCalories || 0) + exerciseHistory.totalCalBurned} = {roundToDecimal(userStatistic.tdee)} - {} + {exerciseHistory.totalCalBurned}
          </Text>
