...
const MealResultDetailScreen = ({ route }) => {
  ...
  return (
    <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.component_container}>
            <View style={styles.sugar_container}>
              ...
              <Text style={styles.value}>{meal.totalCarb} g</Text>
            </View>
            <View style={styles.protein_container}>
              <Text style={styles.name}>Đạm</Text>
              <Text style={styles.value}>{meal.totalProtein} g</Text>
            </View>
            <View style={styles.fat_container}>
              <Text style={styles.name}>Chất béo</Text>
              <Text style={styles.value}>{meal.totalFat} g</Text>
            </View>
          </View>
      ...
      <ModalAddMeal visible={modalVisible} handleCloseModal={handleCloseModal} handleAddMealBreakfast={handleAddMealBreakfast} handleAddMealLunch={handleAddMealLunch} handleAddMealDinner={handleAddMealDinner} handleAddMealSnack={handleAddMealSnack} />
    </View>
  );
};
