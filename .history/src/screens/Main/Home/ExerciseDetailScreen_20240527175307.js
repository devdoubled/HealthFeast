        ...
        <View style={styles.info_container}>
          ...
          <View style={styles.intensity_info}>
            ...
            <View style={styles.choose_intensity}>
              <Pressable style={({ pressed }) => pressed && styles.pressed} onPress={handleDecreaseIntensity}>
                <AntDesign name="down" size={26} color="#E55733" />
              </Pressable>
              <Text style={styles.choose_text}>15%</Text>
              <Pressable style={({ pressed }) => pressed && styles.pressed} onPress={handleIncreaseIntensity}>
                <AntDesign name="up" size={26} color="#E55733" />
              </Pressable>
            </View>
          </View>
