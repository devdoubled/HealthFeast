...
import RunningDropdown from "../../../components/Main/Home/Exercise/RunningDropdown";
        ...
        <View style={styles.info_container}>
          <View style={styles.time_info}>
            ...
            <View style={styles.choose_time}>
              ...
              >
                <AntDesign name="down" size={24} color="#E55733" />
              </Pressable>
              ...
              >
                <AntDesign name="up" size={24} color="#E55733" />
              </Pressable>
            </View>
          </View>
