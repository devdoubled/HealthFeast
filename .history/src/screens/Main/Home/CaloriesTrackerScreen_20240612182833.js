  ...
  useEffect(() => {
    const fetchMealData = async (date) => {
      try {
        ...
        const sumLunchCalories = breakfastMeal.reduce((totalCalories, meal) => totalCalories + meal.calCalories, 0);
        const sumDinnerCalories = breakfastMeal.reduce((totalCalories, meal) => totalCalories + meal.calCalories, 0);
        const sumSnackCalories = breakfastMeal.reduce((totalCalories, meal) => totalCalories + meal.calCalories, 0);
        console.log(sumBreakfastCalories);
