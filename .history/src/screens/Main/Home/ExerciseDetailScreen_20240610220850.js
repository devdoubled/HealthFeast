...
import ModalAddExercise from "../../../components/Main/Home/Exercise/ModalAddExercise";
...
const ExerciseDetailScreen = ({ route }) => {
  const { typeEx, exerciseId, userStatistic } = route.params
  ...
  useEffect(() => {
    const result = calculateCaloriesBurned(userStatistic.weight, time, intensity, valueExercise);
  ...
  const handlePressAddExercise = async () => {
    const exerciseData = {
      ...
      caloriesBurned: calculateCaloriesBurned(userStatistic.weight, time, intensity, valueExercise),
      name: typeExercise
    }
    try {
      const res = await apiClient.post(`/Exercises`, exerciseData);
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.calories_info}>
            <View style={styles.calories_tracker}>
              <Text style={styles.calories_text}>
                {calculateCaloriesBurned(userStatistic.weight, time, intensity, valueExercise)} KCal
              </Text>
            </View>
      ...
      <ModalAddExercise visible={modalVisible} handleCloseModal={handleCloseModal}/>
    </View>
  );
};
