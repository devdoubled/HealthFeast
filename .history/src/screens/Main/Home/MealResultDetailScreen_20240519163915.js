        ...
        <View style={styles.information_container}>
          ...
          <View style={styles.choose_size_container}>
            ...
            <View style={styles.choose_calories}>
              <Pressable style={({pressed}) => pressed && styles.pressed} onPress={handlePressMinusValueCalories}>
              <AntDesign name="minuscircle" size={30} color="#9ABF5A" />
              </Pressable>
              <Text style={styles.choose_text}>100 g</Text>
              <Pressable handlePressPlusValueCalories onPress={handlePressPlusValueCalories}>
