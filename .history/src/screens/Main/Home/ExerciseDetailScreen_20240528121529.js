        ...
        <View style={styles.info_container}>
          ...
          <View style={styles.exercise_options}>
            ...
            <ExerciseDropdown data={() => {
              ...
              else if(typeEx === "Bơi lội") return runningData
              else if(typeEx === "Đá bóng") return runningData
              else if(typeEx === "Bóng rổ") return runningData
              else if(typeEx === "Đạp xe") return runningData
