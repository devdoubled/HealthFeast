...
const ExerciseDetailScreen = ({ route }) => {
  ...
  useEffect(() => {
    const result = calculateCaloriesBurned(, time, intensity, valueExercise);
  ...
  const handlePressAddExercise = async () => {
    const exerciseData = {
      ...
      caloriesBurned: calculateCaloriesBurned(, time, intensity, valueExercise),
      name: typeExercise
    }
          ...
          <View style={styles.calories_info}>
            <View style={styles.calories_tracker}>
              <Text style={styles.calories_text}>
                {calculateCaloriesBurned(, time, intensity, valueExercise)} KCal
              </Text>
            </View>
