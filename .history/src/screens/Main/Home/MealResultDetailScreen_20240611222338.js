...
const MealResultDetailScreen = ({ route }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ModalAddMeal visible={modalVisible} 
      handleCloseModal={handleCloseModal} handleAddMealBreakfast={handleAddMealBreakfast} handleAddMealLunch={handleAddMealLunch} handleAddMealDinner={handleAddMealDinner} handleAddMealSnack={handleAddMealSnack} />
    </View>
  );
};
