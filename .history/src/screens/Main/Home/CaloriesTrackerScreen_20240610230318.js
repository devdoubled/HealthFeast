    ...
    >
      ...
      <View style={[styles.tracker_container, { width: width - 32 }]}>
        ...
        <View style={styles.progress_tracker}>
          <CaloriesProgress eaten={roundToDecimal(userStatistic.tdee) - 2256 + exerciseHistory.totalCalBurned} target={roundToDecimal(userStatistic.tdee)} />
        </View>
        ...
        <View style={styles.explain_container}>
          <Text style={styles.calculate}>
            {roundToDecimal(userStatistic.tdee) - 2256 + exerciseHistory.totalCalBurned} = {roundToDecimal(userStatistic.tdee)} - 2256 + {exerciseHistory.totalCalBurned}
          </Text>
