    ...
    >
      ...
      <View style={[styles.calories_tracker, { width: width - 32 }]}>
        <View style={styles.total_calories}>
          <Text style={styles.total_calories_text}>T</Text>
          <Text style={styles.total_calories_number}></Text>
        </View>
        <View style={styles.net_calories}></View>
        <View style={styles.target_calories}></View>
      </View>
    </ScrollView>
  );
};
