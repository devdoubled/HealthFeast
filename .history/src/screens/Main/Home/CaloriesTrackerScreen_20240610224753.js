    ...
    >
      ...
      <View style={[styles.tracker_container, { width: width - 32 }]}>
        ...
        <View style={styles.meal_tracker}>
          ...
          <View style={styles.tracker}>
            <MealBar label={"Ăn vặt"} value={200} maxValue={roundToDecimal(userStatistic.tdee * 0.25)} />
            <MealBar label={"Ăn tối"} value={200} maxValue={roundToDecimal(userStatistic.tdee * 0.25)} />
          </View>
        </View>
        <View style={styles.explain_container}>
          <Text style={styles.calculate}>0 = {roundToDecimal(userStatistic.tdee)} - 0 + 1500</Text>
