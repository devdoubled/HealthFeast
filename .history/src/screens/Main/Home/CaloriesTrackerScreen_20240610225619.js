    ...
    >
      ...
      <View style={[styles.tracker_container, { width: width - 32 }]}>
        ...
        <View style={styles.explain_container}>
          <Text style={styles.calculate}>{{roundToDecimal(userStatistic.tdee)} - 1256 + {exerciseHistory.totalCalBurned}} = {roundToDecimal(userStatistic.tdee)} - 1256 + {exerciseHistory.totalCalBurned}</Text>
