...
const MealResultDetailScreen = () => {
  ...
  const [wishlistIcon, setWishlistIcon] = useState("staro");
  ...
  const handlePressWishlistIcon = () => {
    if (wishlistIcon === "staro") {
      setWishlistIcon("star");
    } else {
      setWishlistIcon("staro");
    }
  };
      ...
      <View style={[styles.result_detail_container, { width: width - 32 }]}>
        ...
        >
          ...
          <View style={styles.add_action_container}>
            <Pressable style={({pressed}) => [styles.add_btn, pressed && styles.pressed]}>
              <Text style={styles.add_text}>Thêm món ăn</Text>
            </Pressable>
            <Pressable
              onPress={handlePressWishlistIcon}
              style={({pressed}) => [styles.wishlist, pressed && styles.pressed]}
            >
              <AntDesign name={wishlistIcon} size={30} color="#9ABF5A" />
            </Pressable>
          </View>
        </ScrollView>
      </View>
