  ...
  return (
    <View style={styles.container}>
      <View style={[styles.result_detail_container, { width: width - 32 }]}>
        ...
        <ScrollView style={styles.information_container} showsVerticalScrollIndicator={false}
          ...
          <View style={styles.component_container}>
            ...
            <View style={styles.protein_container}></View>
            <View style={styles.fat_container}></View>
          </View>
        </ScrollView>
      </View>
    </View>
