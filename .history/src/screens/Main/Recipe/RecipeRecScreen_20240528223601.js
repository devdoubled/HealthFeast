    ...
    <View style={styles.container}>
      ...
      >
        <View
          ...
          >
            <ImageBackground
              source={{ uri: "https://blog.onelife.vn/wp-content/uploads/2021/10/cach-lam-djau-hu-chien-sot-ca-chua-beo-thom-mon-chinh-600292754928.jpg" }}
              style={styles.recipe_img}
              imageStyle={styles.imageBackground}
            ></ImageBackground>
            <View style={styles.recipe_info}>
              <View style={styles.recipe_main}>
                <Text style={styles.recipe_name}></Text>
                <Text style={styles.recipe_calo}></Text>
              </View>
              <AntDesign name={"staro"} size={30} color="#FFFFFF" />
            </View>
          </View>
      </ScrollView>
    </View>
