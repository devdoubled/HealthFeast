  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.ingredient_container}>
        ...
        <IngredientItem
          icon={
            <MaterialIcons name="local-fire-department" size={22} color="#000000" />
          }
          title={"Lượng calo"}
          number={500}
          unit={"kCal"}
        ...
        <IngredientItem
          icon={
            <MaterialIcons name="access-time" size={22} color="#000000" />
          }
          title={"Thời gian"}
          number={45}
          unit={"Phút"}
      ...
      <View style={styles.recipe_component_container}></View>
    </ScrollView>
  );
};
