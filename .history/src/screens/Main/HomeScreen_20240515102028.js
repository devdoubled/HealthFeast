  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={[styles.macro_tracking, { width: width - 32 }]}>
        <MacroBar label="Đường" value={25} maxValue={50} color="#9ABF5A" />
        <MacroBar label="Đạm" value={25} maxValue={50} color="#FF6347" />
        <MacroBar label="Chất béo" value={25} maxValue={50} color="#FF6347" />
      </View>
    </ScrollView>
  );
};
