  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={[styles.macro_tracking, { width: width - 32 }]}>
        <MacroBar label="Đường" value={150} maxValue={50} color="#9ABF5A" />
        <MacroBar label="Đạm" value={150} maxValue={50} color="#B266FD" />
        <MacroBar label="Chất béo" value={150} maxValue={50} color="#5285E8" />
      </View>
    </ScrollView>
  );
};
