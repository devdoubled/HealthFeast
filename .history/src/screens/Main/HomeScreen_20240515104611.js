      ...
      <View style={[styles.exercise_tracking, { width: width - 32 }]}>
        <View>
          ...
          <View style={styles.exercise_detail}>
            <View style={styles.exercise_calo}></View>
            <View style={styles.exercise_time}></View>
          </View>
        </View>
        <View>stylesstylesstylesstylesstylesstylesstylesstylesstylesstylesstylesstylesstyles
          <Pressable>
