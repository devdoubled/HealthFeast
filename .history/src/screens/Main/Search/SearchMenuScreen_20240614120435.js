...
const SearchMenuScreen = ({ navigation, route }) => {
  ...
  const handleAddMealBreakfast = async (item) => {
    const mealFavorite = {
      recipeId: item.id,
    ...
    console.log(mealFavorite);
  }

  const handleAddMealLunch = async (item) => {
    const mealFavorite = {
      recipeId: item.id,
      accountId: user.accountId,
      mealTime: 2,
  ...
  const handleAddMealDinner = async (item) => {
    const mealFavorite = {
      recipeId: item.id,
      accountId: user.accountId,
      mealTime: 3,
  ...
  const handleAddMealSnack = async (item) => {
    const mealFavorite = {
      recipeId: item.id,
      accountId: user.accountId,
      mealTime: 4,
