...
const SearchMealScreen = ({ navigation, route }) => {
  ...
  const logSelectedMeals = (mealType) => {
    console.log(`${mealType} selected meals:`, mealTimeData[mealType].selected);
  };
      ...
      >
        {[
          ...
          <MealComponent
            ...
            onPressHandler={() => logSelectedMeals(meal.mealType)}
          />
        ))}
      </ScrollView>
    </View>
  ...
  <View style={styles.meal_content}>
    <View style={styles.meal_header}>
      ...
      {selectedMeals.length > 0 ? (
        ...
        <Pressable onPress={onPressHandler}><Entypo name="dots-three-horizontal" size={28} color="#9ABF5A" /></Pressable>
      )}
    </View>
