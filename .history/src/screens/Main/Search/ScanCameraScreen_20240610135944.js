...
const ScanCameraScreen = ({ navigation }) => {
  ...
  const getMimeType = (uri) => {
    ...
    switch (extension) {
      ...
      case 'tiff':
        return 'image/tiff';
      default:
        return 'image/jpeg'; // default to jpeg if the type is unknown
    }
  };
  ...
  data.append('file', {
    ...
    name: `upload.${mimeType.split('/')[1]}`, // Generate a name with the correct extension
  });
    data.append('upload_preset', 'iq6guta');
