  ...
  const takePicture = async () => {
    if (cameraRef.current) {
      ...
      try {
        ...
        const result = await uploadImageForScan("https://res.cloudinary.com/dc0y8lfi5/image/upload/v1718165967/scanImage/s2mksay9ihco7n0p6toy.jpg");
        const { IsFood, Name, RecipeId, IsInDb, Calories, Carbs, Protein, Fat } = result; 
        const scanData = { IsFood, Name, RecipeId, IsInDb, Calories, Carbs, Protein, Fat };
