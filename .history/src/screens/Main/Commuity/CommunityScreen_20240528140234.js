  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <Text style={styles.news_date}>24/02/2024</Text>
          <View style={styles.news_name}><Text style={styles.news_name}>Yêu bản thân, nên bắt đầu bằng việc chăm sóc thể chất hay tinh thần?</Text></View style={styles.news_name}>
        </ImageBackground>
      </ScrollView>
    </View>
  );
