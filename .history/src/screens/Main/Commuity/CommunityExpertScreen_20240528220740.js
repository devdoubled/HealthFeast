  ...
  return (
    <View style={styles.container}>
      ...
      >
        <ImageBackground
          source={{
            uri: "https://nutrihome.vn/wp-content/uploads/2020/07/BS-anpha-1.jpg",
          }}
        ...
        >
          <View style={styles.expert_name_container}>
            ...
            <View style={styles.expert_name}>
              ...
              <Text style={styles.expert_name_text}>Bùi Ngọc An Pha</Text>
              <View style={styles.expert_info}></View>
            </View>
          </View>
        </ImageBackground>
      </ScrollView>
