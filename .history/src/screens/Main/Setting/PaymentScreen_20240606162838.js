        ...
        <View style={styles.container}>
            ...
            <View style={[styles.payment_container, { width: width - 32 }]}>
                ...
                <View style={styles.payment_info_container}>
                    <Pressable style={styles.payment_info_header} onPress={() => setShowPaymentOption(!showPaymentOption)}>
                        <View>
                    ...
                    {showPaymentOption && (
                        <View style={styles.payment_info_content}>
                            <Pressable style={styles.payment_option_momo} onPress={handlePressMomo() => { setShowMomoPayment(true), setShowPaymentOption(false) }}>
                            ...
                            <Pressable style={styles.payment_option_credit} onPress={() => setShowCreditPayment(true)}>
                                <View style={styles.payment_option_img}>
