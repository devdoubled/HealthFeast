            ...
            <View style={[styles.payment_container, { width: width - 32 }]}>
                ...
                <View style={styles.payment_info_container}>
                    ...
                    <View style={styles.payment_info_content}>
                        <View style={styles.payment_option_momo}>
                            <Image source={MomoLogo} style={styles.payment_option_img}/>
                            <Text style={styles.payment_option_text}>Ví momo</Text>
                        </View>
                        <View style={styles.payment_option_credit}>
                            <Image source={CreditLogo} style={styles.payment_option_img}/>
                            <Text style={styles.payment_option_text}>Ví momo</Text>
                        </View>
                    </View>
                </View>
