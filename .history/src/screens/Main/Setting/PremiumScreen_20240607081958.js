...
import { Dimensions, Image, Platform, Pressable, ScrollView, StyleSheet, Text, View, Linking } from 'react-native';
...
const PremiumScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}
      ...
      <Pressable style={({ pressed }) => [styles.continue_btn, pressed && styles.pressed, { width: width - 32 }]} onPress={hanlePressContinue}>
