  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.media}>
        <FontAwesome5 name="facebook" size={24} color="#9ABF5A" />
        <Text style={styles.media_text}>Theo dõi chúng tôi trên Facebook</Text>
      </View>
      <View style={styles.media}>
        <FontAwesome name="instagram" size={24} color="#9ABF5A" />
        <Text style={styles.media_text}>Theo dõi chúng tôi trên Facebook Instagram</Text>
      </View>
    </View>
  )
}
