  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}
      ...
      <View style={[styles.premium_container, { width: width - 32 }]}>
        {premiumPackages.map((package) => (
          <View style={styles.package_item} key={package.id}>
          ...
          <View style={styles.package_feature}>
            ...
            <View style={styles.feature_content}>
              <View style={styles.feature_func}>
                <Text>{'\u2022'}</Text>
                <Text style={styles.feature_func_text}>Kế hoạch bài tập</Text>
              </View>
              <View style={styles.feature_func}>
                <Text>{'\u2022'}</Text>
                <Text style={styles.feature_func_text}>Kế hoạch bài tập</Text>
