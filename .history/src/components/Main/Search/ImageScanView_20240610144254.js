    ...
    >
      ...
      <View style={styles.scan_result_container}>
        <View style={styles.rusult_title}>
          ...
          <Text style={styles.title}>{scanResult.Name}</Text>
        </View>
        <View style={styles.result_calo}>
          <Text style={styles.calo_title}>Tổng lượng calo</Text>
          <Text style={styles.calo_number}>{scanResult.Calories} kCal</Text>
        </View>
        <View style={styles.result_nutrition}>
          ...
          <View style={styles.nutrition_container}>
            <NutritionProgress
              label="Tinh bột"
              color="#9ABF5A"
              nutrition={scanResult.Carbs}
              target={100}
            />
            <NutritionProgress
              label="Đạm"
              color="#E55733"
              nutrition={scanResult.Protein}
              target={100}
              isMiddle={true}
            />
            <NutritionProgress
