      ...
      {isShowDropdown && (
        <View style={styles.dropdown_list}>
          <Pressable style={styles.item_selection}>
            <Text style={styles.item_text}>Mới bắt đầu</Text>
          </Pressable>
          <Pressable style={styles.item_selection}>
            <Text style={styles.item_text}>Trung bình</Text>
          </Pressable>
          <Pressable style={styles.item_selection}>
            <Text style={styles.item_text}>Nâng cao</Text>
          </Pressable>
          <Pressable style={styles.item_selection}>
            <Text style={styles.item_text}>Chuyên nghiệp</Text>
          </Pressable>
        </View>
      )}
    </View>
